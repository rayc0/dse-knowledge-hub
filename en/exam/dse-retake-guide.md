---
title: "HKDSE Retake Guide: Rules, Strategy, and What Changes in 2026"
description: "A complete guide for DSE candidates considering retaking the exam — covering eligibility, private candidate registration, subject selection strategy, JUPAS interactions, 2026 exam changes, and study plans for a successful second attempt."
lang: en
category: exam
date: 2026-04-17
...
- A valid HKID card
- Your previous DSE candidate number (if applicable)
- Payment by credit card or designated bank transfer
- Copies of any required supporting documents (subject-specific, e.g., for School-based Assessment components)
...
- **English Language** — typically the subject most students want to improve, and the one with the most structured retake courses available
- **Mathematics (Compulsory Part)** — high leverage for students targeting science, engineering, or business programmes
- **Chinese Language** — harder to improve rapidly but critical for many local university programmes
- **Biology, Chemistry, or Physics** — for students targeting medical, dental, pharmacy, or engineering programmes where a Level 4 or 5 in a specific science is required
...
This means:
- If you scored Level 3 in English in 2025 and Level 4 in English in 2026, JUPAS uses the Level 4.
- If you scored Level 5 in Biology in 2025 but only Level 4 in 2026 (a worse second attempt), JUPAS uses the Level 5.
- There is no penalty for a lower second score.
...
- **You narrowly missed a programme's minimum requirement** — e.g., you need Level 4 in English and scored Level 3. One grade point in one subject is an achievable, defined target.
- **Your results were clearly below your capability** — illness, family disruption, or exam-day anxiety led to results that do not reflect your actual ability. A structured retake can close that gap.
- **You have a specific high-value target** — medicine, law, and a handful of engineering and finance programmes have requirements strict enough that one better result genuinely changes your options.
- **You performed unevenly across subjects** — perhaps you did well in most subjects but had one poor performance. Retaking that one subject is low-cost and high-upside.

### When the Case for Retaking Is Weaker

- **The gap is large across multiple subjects** — if you need to improve three or four subjects by two levels each, you are essentially re-sitting the entire exam from a significantly lower baseline. The probability of success drops, and the psychological toll is substantial.
- **Alternative routes exist and are comparable** — associate degree (AD) and higher diploma (HD) programmes offer genuine pathways into year two or three of bachelor's degree programmes. For many careers, an AD-to-degree pathway is just as effective as direct admission, and it lets you start accumulating credits immediately.
- **Time is the constraint** — a year is a significant investment. If you are 18 or 19, one year feels long but is objectively manageable. If you are in your mid-twenties and have other priorities, the opportunity cost calculation may be different.
- **Your target programme has holistic admission** — if your chosen programme weights interviews, portfolios, or work experience heavily, an extra grade point may matter less than you think.
...
- **3–4 hours of focused study per day** (not including breaks)
- **One full practice exam per week** per subject in the final two months
- **Monthly check-ins** against your target grade: are you consistently hitting it in practice? If not, adjust before it is too late.
- **Rest is not optional** — burnout in January or February will cost you more than any single study session is worth.
...
- **Mandatory military/national service**: Not applicable in Hong Kong, but worth mentioning for candidates who hold foreign nationalities.
- **Part-time work**: Many retake candidates work part-time. This is manageable if hours are limited (15–20 hours per week) but becomes a serious problem if work encroaches on study time in the final three months before the exam.
- **Mental health**: Isolation is a real risk. Build social activities into your week deliberately — not as a reward for studying, but as a non-negotiable part of a sustainable routine.
- **University deferral**: If you received a university offer in your first sitting year, check whether deferral is possible. Some programmes allow a one-year deferral, which eliminates the retake entirely if your original offer is for a programme you would be satisfied with.

---

## Key Takeaways

- **Any previous DSE candidate can retake as a private candidate** — there is no age limit and no ceiling on the number of attempts.
- **Register in late August/September** through the HKEAA online portal. Missing the deadline means waiting another year.
- **JUPAS uses your best result per subject across all sittings** — a worse second attempt cannot hurt you, but always verify programme-specific exceptions.
- **Exam fees run approximately HK$310–HK$450 per subject** — budget carefully, especially if adding tuition costs.
- **CSD replaced Liberal Studies** for candidates from the class of 2024 onward; most universities accept either result at the appropriate standard.
- **Target specific subjects** rather than retaking everything — the strongest retake cases involve one to two subjects where you narrowly missed a defined threshold.
- **Past papers and timed practice** are the most reliable study tools; use HKEAA's free published resources.
- **The psychological dimension is real** — build in social support, track your progress, and keep a concrete goal visible.
- **Alternatives exist** — associate degree and higher diploma pathways are legitimate routes to bachelor's programmes and should be evaluated alongside retaking, not dismissed.
