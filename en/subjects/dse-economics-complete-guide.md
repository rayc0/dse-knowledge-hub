---
title: "DSE Economics Complete Guide 2026 — Syllabus, Paper Structure, Study Strategy, and Top Scorer Tips"
description: "A comprehensive guide to HKDSE Economics (Elective) for 2026 candidates. Covers full syllabus breakdown, Paper 1 MC and Paper 2 LQ structures, common pitfalls, graph-drawing essentials, SBA removal changes, and high-scoring strategies from 5** students."
lang: en
category: subjects
date: 2026-04-15
...
8. **National Income Accounting and Business Cycle** — GDP, GNI, nominal vs real, economic growth, business cycle phases
9. **Money, Banking, and Monetary Policy** — functions of money, money supply, banking system, interest rate, Hong Kong Linked Exchange Rate System
10. **Macroeconomic Problems and Policies** — inflation, unemployment, fiscal policy, monetary policy, supply-side policy
...
- **45 MC questions**
- All 45 compulsory
- Topics spread across all 10 themes
- Graph interpretation questions are typically 8-10 of the 45
- Calculation questions (elasticity, GDP, multiplier) typically 5-7 of the 45

### Paper 2 — Long Questions (2 hours 15 minutes, 70%)

- **Section A — Compulsory short questions** (8-10 questions, ~30 marks)
- **Section B — Essay/structured long questions** (choice of 3 out of 4, ~70 marks)
- Tests both microeconomics and macroeconomics
- Graph drawing is required in at least 50% of questions
- Case study analysis (e.g., "Hong Kong property market 2024") frequently used as question stems
...
- No teacher-assessed component during S5 or S6
- No coursework portfolio
- Paper 1 weight unchanged at 30%
- Paper 2 weight unchanged at 70%
...
- **Master every single past paper** from 2012 (first DSE year) to 2025 — that's 13 sets of papers, approximately 50-60 hours of full attempts
- **Read beyond the textbook**: The Economist, SCMP Business, Hong Kong Monetary Authority working papers for real-world case context
- **Develop "model answer templates"** for each common essay type (market failure essay, elasticity essay, monetary policy essay) and practice applying them to different case scenarios
- **Perfect graph drawing** — every diagram must have: labeled axes (P and Q, not just letters), equilibrium points marked, shifts shown with arrows, welfare changes shaded
- **Get feedback from a 5** tutor** on at least 10 full essay attempts; solo practice without feedback plateaus around 4-5 level
- **Target Paper 1 at 42+/45** and Paper 2 at 60+/100 raw

### For 5 / 4 (Middle 30%)

- Complete **at least 8 sets of past papers** (2018-2025)
- Focus on **Paper 1 first** — it is the most reliable source of marks and has predictable patterns
- Memorize **key definitions** verbatim (opportunity cost, elasticity formulas, money supply aggregates) — markers give partial marks for correct keyword usage
- Review the **HKEAA marker reports** (available free on hkeaa.edu.hk) for each past paper to understand what examiners look for
- Focus essay practice on the **"top 6" most-tested topics** above

### For 3 (Passing Grade)

- Master **Themes 1-5** (micro basics) completely — these generate ~60% of the paper marks
- Do **all Paper 1 MC** from past papers; MC alone can carry a weak student to grade 3
- Learn **5 essay templates** covering the most common topics; memorize them well enough to adapt to different question stems
- Use **Chinese textbook explanations** alongside English if you struggle with technical vocabulary
...
- Market-level analysis → S-D diagram
- Firm-level analysis → MR, MC, ATC, AR diagram
- Macroeconomic analysis → AD-AS diagram (not S-D)
- Money market → MD-MS diagram with interest rate on y-axis
...
Students confuse:
- "Total revenue increases when price falls" → true only if demand is price-elastic
- "Demand is inelastic" → quantity changes proportionately less than price
- "YED < 0" → inferior good, not "poor quality good"
...
- **Aristo New Economics in Life** — most popular, strong diagrams and exam-style questions
- **Pearson Longman HKDSE Economics** — excellent for macroeconomics clarity
- **Hong Kong Educational Publishing Economics Today** — good for average students, Chinese/English bilingual

### Past Papers and Marker Reports

- **HKEAA** website: www.hkeaa.edu.hk/en/hkdse/assessment/past_papers
- Marker reports contain examiner's exact expectations — **underused resource**

### Tutorial Centers

- **Beacon College, Modern Education, King's Glory, Kenneth Lau**, etc. — all offer DSE Economics packages; cost HKD 4,000-12,000 per year
- **One-to-one tutoring** from university students or recent 5** graduates: HKD 250-600/hour

### Self-Study Resources

- **Hong Kong Monetary Authority** (www.hkma.gov.hk) for Linked Exchange Rate primary source
- **Hong Kong government budget speech** annually for fiscal policy context
- **Investopedia** for any concept you find the textbook unclear on
- **Khan Academy Economics** (YouTube) for visual learners

## What About University Applications?

DSE Economics is strong preparation for:
- **Business and Economics** programs at HKU, CUHK, HKUST, CityU, PolyU
- **Actuarial Science** (pairs excellently with Math M2 + Economics)
- **Quantitative Finance** (often requires Economics + Math)
