...
- **English Language**: Level 4 or above (Level 5 expected for competitive applications)
- **Mathematics (Compulsory Part)**: Level 2 or above
- **Citizenship and Social Development / Liberal Studies**: Attained
...
- Equity and Trusts
- Company Law
- Civil Procedure / Evidence (varies by school)
...
## The PCLL: The Gateway to Legal Practice
...
- Drafting (legal documents, contracts, letters, court submissions)
- Advocacy (oral argument, courtroom procedure)
- Interviewing and advising (simulated client interactions)
...
- A **First Class Honours** degree gives you a strong competitive position.
- An **Upper Second Class Honours (2:1)** is generally required to be competitive.
- A **Lower Second Class Honours (2:2)** significantly reduces your chances and may require you to apply multiple times or consider other pathways.
...
- Graduates of non-law disciplines (business, engineering, sciences) who decide to pursue law after their undergraduate degree
- Students who completed a UK or overseas undergraduate law degree not automatically recognised for Hong Kong PCLL purposes
- Professionals seeking a career change into law who want to leverage their domain expertise (e.g., an accountant who qualifies as a lawyer to practise in financial regulation)
...
### Alternative Legal Services and LegalTech
...
- **Three JUPAS law schools**: HKU (strongest brand, ~120 places), CUHK (China law focus, ~80 places), CityU (clinical/professional focus, ~100 places). Total combined intake is approximately 300 places per year.

- **DSE score requirements are among the highest of any major**: Median admission at HKU Law requires approximately Best-5 scores in the 27–29 range. English Language at Level 5 or above is effectively expected at all three schools.

- **No required elective subjects**, but English Language carries outsized weight. Strong essay-writing electives (Literature, History, Economics) build skills the degree demands.

- **Two-stage professional pathway**: LLB (4 years) → PCLL (1 year) → Training Contract / Pupillage (1–2 years) before full qualification. The PCLL is a separate competitive application, not an automatic progression.

- **Non-law graduates can enter via the JD** — a 2-year postgraduate conversion degree offered at HKU, CUHK, and CityU — before proceeding to PCLL on the same basis as LLB graduates.

- **Career paths are broader than the courtroom**: private practice, in-house counsel, Government Legal Service, financial regulation and compliance, and LegalTech are all viable outcomes for law graduates.

- **Degree classification is critical**: aim for Upper Second Honours (2:1) minimum throughout your LLB to remain competitive for PCLL admission and training contract recruitment. First Class Honours significantly improves your options.

- **Apply strategically on JUPAS**: law schools should be positioned in the correct band for your score range. Do not underestimate law's competitiveness relative to your other choices.
