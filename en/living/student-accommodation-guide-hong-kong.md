---
title: "Student Accommodation in Hong Kong: A Practical Guide for International and Mainland DSE Students"
description: "A comprehensive guide to student accommodation in Hong Kong for international and mainland students. Covers university halls, private hostels, shared flats, PMQ-style co-living, district-by-district rental comparisons, deposit rules, utility costs, and how to avoid common scams."
lang: en
category: living
date: 2026-04-15
...
- [ ] Room size (ask for floor plan)
- [ ] Bathroom arrangement (private or shared)
- [ ] Kitchen access
- [ ] Laundry facilities
- [ ] Internet speed
- [ ] Cancellation policy
- [ ] Hidden fees (cleaning, maintenance)
...
- [ ] Open HK bank account (HSBC / Bank of China / Standard Chartered)
- [ ] Get Octopus card
- [ ] Register with university student services
- [ ] Collect HKID at Immigration Department (within 30 days)
- [ ] Get local SIM card
- [ ] Buy bed sheets, pillow, towel, toiletries
- [ ] Find nearest supermarket (ParknShop, Wellcome, 7-Eleven)
