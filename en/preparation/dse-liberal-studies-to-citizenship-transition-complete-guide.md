---
title: "DSE Liberal Studies to Citizenship & Social Development: The Complete Transition Guide"
description: "A comprehensive English-language guide explaining the transition from Liberal Studies to Citizenship and Social Development (CSD) in the HKDSE, what changed, what stayed the same, how students should study the new subject, and what parents and educators need to know."
lang: en
...
- **Compulsory** (like Liberal Studies).
- **Pass-or-fail only**, reported as Attained / Not Attained rather than Level 1–5**.
- **Covering three themes**: "Hong Kong under 'One Country, Two Systems'", "Our Country Since Reform and Opening-Up", and "Interconnectedness and Interdependence of the Contemporary World".
- **Including a compulsory mainland study tour** as part of the curriculum (one trip during senior secondary).
- **Designed for roughly half the teaching time** previously allocated to Liberal Studies.
- **Assessed by a single public examination** of two papers, without the school-based IES.
...
- **Compulsory status**: every DSE candidate must sit the subject.
- **Core aim of civic literacy**: both subjects aim to develop students' understanding of Hong Kong, China, and the wider world.
- **Data-response question style**: students still read source materials (text, charts, cartoons) and write analytical responses.
- **English-medium option**: schools that deliver the DSE in English can continue to do so for CSD.
- **Integration with other subjects**: knowledge from economics, history, geography, and biology still informs CSD responses, just as it did Liberal Studies.
- **Emphasis on current affairs**: staying aware of local, national, and global developments remains essential.
...
- The historical background of the Basic Law and the handover.
- The "One Country, Two Systems" principle and its practical operation.
- Hong Kong's political structures: executive, legislature, judiciary, District Councils.
- The rule of law as a core value.
- Social issues: housing, inequality, ageing population, mental health, healthcare system.
- Economic development: the four pillar industries (finance, tourism, trade and logistics, professional services), emerging sectors (innovation and technology, creative industries), and the Greater Bay Area.
...
- Historical background: from planned economy to "socialism with Chinese characteristics".
- Economic reform stages: rural household responsibility system, Special Economic Zones, WTO accession, supply-side reform.
- Poverty alleviation and the elimination of absolute poverty.
- Urbanisation, rural revitalisation, and regional disparities.
- Science and technology: major national initiatives, the innovation ecosystem, space and deep-sea programmes.
- Environment and ecological civilisation: carbon neutrality targets, pollution control, biodiversity.
- Governance and the legal system.
- National symbols, the Constitution, and national security law.
- Belt and Road Initiative and regional cooperation.
- Major national strategies: Yangtze River Economic Belt, Greater Bay Area, Beijing-Tianjin-Hebei coordination.
...
- Globalisation: economic, cultural, technological dimensions.
- Global public health: pandemic response, disease surveillance, WHO.
- Climate change and environmental cooperation.
- Food security and water resources.
- Sustainable development goals.
- Technology and the digital divide.
- International trade frameworks, WTO, regional trade agreements.
- Cultural exchange and cross-cultural understanding.
- Global governance structures and challenges.
...
- Greater Bay Area cities (Guangzhou, Shenzhen, Zhuhai, Foshan, Dongguan).
- Beijing and Shanghai.
- Historical sites in Guangdong and Fujian.
- Technology and innovation centres (Huawei, DJI facilities).
...
- Format: source-based questions using text extracts, charts, images, or statistics
- Question style: short-answer and mid-length responses
- Assesses: comprehension, analysis, use of source material

**Paper 2 — Extended Response Questions**
- Duration: approximately 1 hour 15 minutes
- Format: choice of longer-form questions requiring structured argument
- Question style: essays with introduction, body, conclusion
- Assesses: synthesis, argument, application of knowledge
...
- **JUPAS (local universities):** CSD is a minimum entry requirement — typically "Attained" is required alongside minimum levels in Chinese, English, Mathematics, and one elective. CSD does not contribute points to the admission score.
- **Non-JUPAS local applications:** Policies vary. Some programmes explicitly require "Attained"; others treat it as a general entry requirement alongside four core subjects.
- **Overseas universities:** Initially there was confusion about how to interpret CSD on a DSE transcript. Most major destinations (UK, Australia, Canada, Singapore, USA) have since clarified that they treat CSD analogously to other compulsory pass-or-fail components and focus their admissions decisions on the graded subjects.
...
- **Describe**: state what the data shows; no causes needed.
- **Explain**: give reasons for a phenomenon.
- **Compare**: identify similarities and differences with explicit structure.
- **Analyse**: break down into parts, show relationships.
- **Evaluate**: weigh for and against; conclude with a judgement.
- **Suggest**: propose and justify a realistic solution.
- **To what extent**: argue for and against, then state a degree.
...
**Q1. Is CSD easier than Liberal Studies was?**
Yes and no. The content is narrower and there is no school-based assessment, which reduces year-round workload. But the Attained threshold is genuine, and students who assume it is trivial have failed. The examination technique and source-based responses are still demanding.

**Q2. Can I self-study CSD like some DSE candidates did with Liberal Studies?**
It is possible but harder. The compulsory mainland study tour requires school enrolment or an alternative arrangement, and the examination techniques benefit from teacher feedback. Most self-study candidates arrange tuition support.

**Q3. How does CSD affect my admission score for HKU Medicine?**
CSD attained is a prerequisite but does not add to the points calculation. Admission scores are based on your best four or five academic electives plus Chinese and English, depending on the programme. Check each faculty's specific formula.

**Q4. Can I skip the mainland study tour?**
No — it is a curriculum requirement. Schools arrange alternatives only for documented medical or exceptional cases.

**Q5. What happens if I get Not Attained?**
You have failed a compulsory component of the DSE. You can retake CSD in a later examination sitting. Your overall DSE result is affected.

**Q6. Is CSD recognised by overseas universities?**
Yes, as part of the DSE transcript. Most overseas universities focus on your graded subjects and treat CSD as a pass-fail curriculum requirement comparable to other compulsory components.

**Q7. Which textbooks should I use?**
Use any EDB-approved current CSD textbook. Do not use old Liberal Studies textbooks as your main resource — coverage differs.

**Q8. I came from an international school and only have one year to prepare. Is that enough?**
It is tight but feasible. Prioritise the curriculum document, one good textbook, current affairs reading, and targeted past-paper practice. Tuition support is useful for technique.

**Q9. Will the exam include questions on very recent events?**
Yes — expect questions to reference recent months of current affairs. Examiners do not expect exhaustive detail but do expect you to know the broad landscape.

**Q10. Is there an independent enquiry study (IES) like Liberal Studies had?**
No. CSD has no school-based assessment component.

**Q11. Can I answer in English if I sit CSD in an English-medium school?**
Yes. CSD is offered in both English and Chinese. Answer in your school's medium of instruction.

**Q12. How do I know what "Attained" actually requires?**
HKEAA publishes exemplar answers and mark schemes. Your teachers can access these and walk you through them. A disciplined, average student with consistent preparation should attain without dramatic effort; students who ignore the subject risk failing.

**Q13. My parents want me to focus on sciences and think CSD is a waste of time. What should I tell them?**
CSD is compulsory — you cannot skip it. Treating it as a modest, steady commitment that secures "Attained" is the sensible position. It should not monopolise your study time, but it cannot be ignored.

**Q14. Are there past papers available?**
Yes. HKEAA releases past papers after each examination cycle. Use them for timed practice and review.

**Q15. How much weight should I give CSD relative to my electives?**
Allocate roughly 10–15% of total study time to CSD during normal weeks, scaling up modestly in the final revision period. Your graded electives deserve the majority of your effort, since they determine your admission score.
