...
> **摘要**：香港八大已有 7 所设立数据科学或人工智能相关本科课程，HKUST DST、HKU AI&DataSc、CUHK AIST 为最受认可的三大旗舰项目；DSE 入读竞争分约 33222（五科），数学延伸 M2 为实际竞争加分关键；香港初级数据科学家月薪约 HK$2.2–3.5 万，金融科技方向高出行业均值 30–50%。
> 本文由 the editorial team AI 编辑团队独立撰寫，引用香港大学、香港科技大学、香港中文大学官方课程页面及 Glassdoor/Morgan McKinley 2026 薪酬数据。License: CC BY 4.0.
...
- 适合想做数据驱动决策、ML 模型开发、AI 研究的学生
- 职业路径更垂直，但在热门行业（金融、生命科学、科技）中薪资潜力显著
...
- **英语 + 粤语/普通话**的三语组合在跨国 AI 公司中极具价值
- **香港学历**在大湾区企业中认可度高，尤其是港大、科大、中大的理工科学位
- **大湾区人才政策**：广东省及深圳市均设有针对香港居民的人才引进优惠政策（含住房补贴和个税优惠）
- **IANG 签证通道**：港校毕业后可申请 24 个月不限工种居港签证，自由探索大湾区机会

### 香港的 AI 生态角色

香港在大湾区 AI 格局中的定位正在清晰化：

- **金融 AI 枢纽**：汇丰、摩根大通、渣打等国际金融机构在港大量招募数据科学家，金融科技监管沙盒环境为 AI 应用提供空间
- **学术研究中心**：港大、科大、中大的 AI 研究实验室多次在国际顶级会议（NeurIPS、ICLR、ICML）发表论文，研究经费充足
- **初创生态**：香港 Cyberport 聚集逾 2,000 家科技公司，香港科学园入驻 AI 初创超过 400 家，提供丰富实习和就业机会
- **监管优势**：香港对国际数据流动限制相对较少，适合从事跨境 AI 研究与开发
...
- **授课型硕士（MSc Data Science / AI）**：1–1.5 年，香港本地或海外（LSE、UCL、NUS、CMU、ETH Zurich 等）
- **EngD（工程博士）**：专为工业界设计，结合企业研究与学术训练，部分由雇主赞助
- **MPhil/PhD**：适合有学术志向的学生，香港研究院奖学金（HKPFS）提供全额学费 + 每月约 HK$1.9 万生活费，竞争激烈
...
1. HKU School of Computing and Data Science — Undergraduate Programmes: https://www.cds.hku.hk/prospective-students/undergraduate/
2. HKUST BSc in Data Science and Technology (DSCT) — Official Programme Page: https://dsct.hkust.edu.hk/home
3. HKUST — Join HKUST Data Science and Technology: https://join.hkust.edu.hk/our-programs/joint-school-program/data-science-and-technology
4. JUPAS — 2026 Programme Information (各院校课程入学要求): https://www.jupas.edu.hk/
5. Glassdoor — Junior Data Scientist Salary Hong Kong 2026: https://www.glassdoor.com.hk/Salaries/junior-data-scientist-salary-SRCH_KO0,21.htm
6. Morgan McKinley — Data Scientist Salaries Hong Kong SAR: 2026 Salary Guide: https://www.morganmckinley.com/hk/salary-guide/data/data-scientist/hong-kong-sar
7. Jobsdb Hong Kong — Data Scientist Salary (March 2026): https://hk.jobsdb.com/career-advice/role/data-scientist/salary
8. Hong Kong Cyberport — About Cyberport Ecosystem: https://www.cyberport.hk/en/about_cyberport/overview/
9. HKUST — JUPAS Admissions 2026 Requirements: https://publication.join.ust.hk/view/13965330
...
- [香港计算机与工程专业深度解析](/zh-hans/majors/cs-and-engineering)
- [香港八大金融与会计专业完整申请指南](/zh-hans/majors/finance-and-accounting-hk)
- [DSE 备考六个月学习计划](/zh-hans/preparation/dse-study-plan-6-months)
